        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            <li class="nav-item dropdown dropdown-user">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="{{route('admin.updateProfile')}}"><i class="me-50" data-feather="edit"></i> Update Profile</a>
                    <a class="dropdown-item" href="{{route('admin.changePassword')}}"><i class="me-50" data-feather="key"></i> Change Password</a>
