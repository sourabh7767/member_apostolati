...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return view('admin.view', compact("userObj"));
        } catch (\Exception $ex) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.edit', compact('userObj'));
        } catch (\Exception $ex) {
            if ($ex->getMessage() == "The payload is invalid.") {
                return redirect()->back()->with('error', "Invalid-request");
            }
    ...
    public function profile()
    {
        ...
        return view('admin.profile', compact("userObject"));
    }

    public function showUpdateProfileForm()
    {
        $userObject = Auth()->user();
        return view('admin.updateProfile', compact("userObject"));
    }
